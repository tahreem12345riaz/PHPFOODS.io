...
<div class="container-fluid"> 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
      <a class="nav-link" href="#" style="color:darkblue;">Total price:<?php total_cart_prices();?></a>
      </li>
    </ul>
    <form class="d-flex">
...
<p style="color:darkblue;backgroundcolor:green;font-family:italian;">All right reserved @@@ Designed by zani -2023</p>
</div>
